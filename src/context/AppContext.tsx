...
export const fallbackTranslations: TranslationData = {
  de: { 
    ...
    about: { title: "Über mich", text: "Hinter Rebo Salon stehe ich, dein persönlicher Barber. Mit jahrelanger Erfahrung und einem scharfen Blick für Details ist es meine Mission, dir nicht nur einen Haarschnitt, sondern ein echtes Upgrade für dein Selbstbewusstsein zu geben. Qualität, Präzision und dein Style stehen bei mir an erster Stelle." }, 
